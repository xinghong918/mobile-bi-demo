        ...
        function (oj, ko, jsonData, moment)
        {
            ...
            function PersonViewModel() {
                ...
                self.personClickHandler = function (data) {
                    ...
                    var newPage = "personDetails/" + "about";
                ...
                function loadTeamData(data) {
                    ...
                    self.infoTiles([
                        {"sid": "1", "name": "Item1", "title": "品类", "infolable2": "Tenure", "infolable2value": self.getTenure(data)},
                        {"sid": "2", "name": "Item2", "title": "区域","infolable2": "Potential", "infolable2value": data.potential},
                        {"sid": "3", "name": "Item3", "title": "渠道", "infolable2": "Ratio", "infolable2value": data.compRatio},
                        {"sid": "4", "name": "Item4", "title": "客户系统","infolable2": "Directs", "infolable2value": self.directReports().length}
                    ]);
                }
